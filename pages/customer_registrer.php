...
<?php
require_once '../php/client_signup.php';
?>
<!DOCTYPE html>
<html>
<head>
	...
	<div class="page-content">
		<div class="form-v6-content">
			...
			<form class="form-detail" action="#" method="post">
				...
				<div class="form-row">
					<input type="text" name="txt_phoneNumber" id="phoneNumbere" class="input-text" placeholder="Your Phone Number" required>
				</div>
				<div class="form-row">
					<input type="text" name="txt_address" id="address" class="input-text" placeholder="Your physical address" required">
				</div>
				<div class="form-row">
					<input type="text" name="txt_email" id="your-email" class="input-text" placeholder="Email Address" required pattern="[^@]+@[^@]+.[a-zA-Z]{2,6}">
				</div>
